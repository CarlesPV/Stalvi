...
void main() {
  ...
  test(
    'getTransactionsForPeriod should return transactions in the period',
    () async {
      // Arrange
  ...
  test(
    'getTransactionsForPeriod should return empty list when DB is empty',
    () async {
      final result = await dao.getTransactionsForPeriod(
        DateTime(2023, 1, 1),
        DateTime(2023, 1, 31),
  ...
  test(
    'getTransactionsForPeriod should filter by accountId when provided',
    () async {
      final now = DateTime.now();
      await database.into(database.profiles).insert(
            ProfilesCompanion.insert(
