...
void main() {
  ...
  group('ExchangeRateRemoteDataSourceImpl — fetchLatestRates', () {
    ...
    test(
      ...
      'THEN returns a correctly parsed ExchangeRateModel',
      () async {
        // Arrange
    ...
    test(
      ...
      'WHEN fetchLatestRates is called '
      'THEN throws NetworkException with code HTTP_4XX',
      () async {
        // Arrange
    ...
    test(
      ...
      'WHEN fetchLatestRates is called '
      'THEN throws NetworkException with code HTTP_5XX',
      () async {
        // Arrange
    ...
    test(
      ...
      'WHEN fetchLatestRates is called '
      'THEN throws NetworkException with code NO_INTERNET',
      () async {
        // Arrange
        whenGetThrows(
    ...
    test(
      ...
      'WHEN fetchLatestRates is called '
      'THEN throws NetworkException with code PARSE_ERROR',
      () async {
        // Arrange
