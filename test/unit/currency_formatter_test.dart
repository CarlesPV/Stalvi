...
void main() {
  group('CurrencyFormatter Tests', () {
    ...
    test('tryParse parses currency strings correctly', () {
      expect(
          CurrencyFormatter.tryParse('\$1,234.56', locale: 'en_US'), 1234.56,);
      expect(
          CurrencyFormatter.tryParse('1.234,56 €', locale: 'es_ES'), 1234.56,);
    ...
    test('formatPercentage formats percentage correctly', () {
      ...
      final signed = CurrencyFormatter.formatPercentage(0.125,
          locale: 'en_US', showSign: true,);
