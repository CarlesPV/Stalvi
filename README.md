...
* **Full Tags & Labels Integration:** Optional tag/label assignment directly on standard transactions across database schema, domain models, multi-dimensional filtering, CSV/PDF exports, and encrypted JSON backups.
