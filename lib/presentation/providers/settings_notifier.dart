...
///
/// Default state is `true` (ON). When toggling ON, it verifies and requests
...
class SettingsNotifier extends Notifier<bool> {
  ...
  ///   2. If not granted, requests notification permission.
  ///   3. If permission is granted, persists and sets state to `true`.
  ///   4. If permission is denied, reverts state to `false` and persists `false`.
  /// If toggling OFF:
